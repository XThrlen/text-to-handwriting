...
- [Fork](https://github.com/xthrlen/text-to-handwriting/fork) this repository.

*Note: You need NodeJS installed in your machine to run formatter and server*

```
git clone https://github.com/xthrlen/text-to-handwriting
...
- You can pick any of the issues from [Issues](https://github.com/xthrlen/text-to-handwriting/issues) or If you feel like it needs extra feature or if you find bug, you can create your own issue.
...
If you are still scared to drop a PR or need any help, you can always drop me a message on my [Telegram @XThrlen](https://t.me/xthrlen) or drop me an email at saurabhdaware99@gmail.com.
