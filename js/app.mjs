 ...
 *
 * If you have any questions related to code, you can drop them in my Telegram DM @XThrlen
 * or in my email at tg.srchub@gmail.com
 *
...
fetch(
  'https://api.github.com/repos/XThrlen/text-to-handwriting/contributors'
)
  .then((res) => res.json())
  .then((res) => {
